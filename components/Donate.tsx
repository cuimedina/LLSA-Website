  ...
  return (
    <section id="donate" className="py-24 md:py-32 bg-white text-llsa-charcoal text-center">
      <div className="max-w-4xl mx-auto px-6">
        <span className="text-[10px] font-bold tracking-label uppercase text-llsa-accent mb-8 block">Contribute</span>
        ...
        <div className="flex flex-col items-center">
          <a 
            ...
            className="inline-block px-16 md:px-24 py-5 bg-llsa-accent text-white text-[12px] font-bold uppercase tracking-widest hover:bg-llsa-charcoal transition-all shadow-xl rounded-sm"
          >
            Donate Now
          </a>
          ...
          <p className="mt-4 text-[10px] text-llsa-accent font-bold uppercase tracking-widest">
